...
function Hero() {
  return (
    <section className="flex flex-col md:flex-row items-start justify-between py-20 px-4  bg-gray-50 rounded-md ">
      ...
      <div className="hidden lg:flex justify-end   rounded-md border-1 border-gray-300   bg-white  ">
        <div className="p-2  bg-gray-100 shadow-xl   rounded-md">
          <Image
            alt="bg-removed"
